...
- [Shared Kernel Foundation Slice](src/features/SharedKernel/Foundation/Zeus.Academia.Features.SharedKernel.Foundation.csproj) ([Verify](eng/verify-shared-kernel-sqlserver.ps1))
