...
description: "Vitest testing standards for Vue 3 feature-domain application code"
...
- `src/features/**/__tests__/` - Test files in `__tests__` folders inside feature domains
- `src/features/**/*.test.ts` - Unit test files alongside source
- `src/features/**/*.spec.ts` - Component spec files
- `src/shared/**/*.test.ts` - Shared composable and utility tests
...
describe("useStudentEnrollment", () => {
  ...
  describe("enrollments", () => {
    it("returns enrollments from store", () => {
      ...
      expect(mockStore.getEnrollmentsByStudent).toHaveBeenCalledWith(
        "student-123",
      );
    });
  });
...
```typescript
// src/features/students/listStudents/__tests__/StudentCard.spec.ts
import { describe, it, expect, vi } from "vitest";
import { render, screen, fireEvent } from "@testing-library/vue";
import StudentCard from "../StudentCard.vue";
import type { Student } from "../../shared/student.types";
...
```typescript
// src/features/students/listStudents/__tests__/useStudentStore.test.ts
import { describe, it, expect, beforeEach, vi } from "vitest";
...
```typescript
// src/features/students/shared/__tests__/studentApi.test.ts
import { describe, it, expect, beforeEach, vi } from "vitest";
...
```typescript
// src/features/students/listStudents/__tests__/StudentList.spec.ts
import { describe, it, expect, vi } from "vitest";
import { render, screen, waitFor } from "@testing-library/vue";
import StudentList from "../StudentList.vue";
import { useStudentStore } from "../useStudentStore";

vi.mock("../useStudentStore");
